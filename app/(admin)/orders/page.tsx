  ...
  return (
    <div className="space-y-8">
      <div className="font-nunito font-medium">
        {/* tabs */}
        <div className="w-[500px] h-[59px] grid grid-cols-4 gap-10 mb-[30px]">
          <div
            onClick={() => handleStatusChange("All Orders")}
            className={`border-b ${status === "All Orders" ? "border-F59E0B" : "border-transparent"} flex items-center justify-center gap-3 h-full cursor-pointer`}
          >
            <p
          ...
          <div
            ...
            className={`border-b ${status === "Pending" ? "border-F59E0B" : "border-transparent"} flex items-center justify-center gap-3 h-full cursor-pointer`}
          >
            <p
          ...
          <div
            ...
            className={`border-b ${status === "Approved" ? "border-F59E0B" : "border-transparent"} flex items-center justify-center gap-3 h-full cursor-pointer`}
          >
            <p
          ...
          <div
            ...
            className={`border-b ${status === "Rejected" ? "border-F59E0B" : "border-transparent"} flex items-center justify-center gap-3 h-full cursor-pointer`}
          >
            <p
                ...
                <div className="col-span-4 text-sm text-FCFAFA flex items-center gap-4">
                  <div className="w-12 h-12 rounded object-cover bg-red shrink-0 overflow-hidden flex items-center justify-center text-xs font-bold">
                    {order.drawing?.preview_images?.[0] ? (
                      ...
                      <>
                        {order.drawing_title ? order.drawing_title.substring(0, 2).toUpperCase() : "DR"}
                      </>
                    )}
                  </div>
                  <div className="space-y-2">
                    ...
                    <p className="text-[11px] text-D6D6D6">Ref: {order.paystack_reference || order.id.substring(0, 8)}</p>
                  </div>
                </div>
