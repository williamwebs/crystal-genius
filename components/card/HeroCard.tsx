...
const HeroCard = ({ src, title, content, className }: Props) => {
  return (
    <div
      className={`w-full md:w-1/3 h-full px-3 border-none flex flex-col gap-1 bg-white py-2 transition-all duration-500 hover:scale-105 hover:rounded-lg hover:shadow-lg ${className}`}
    >
